local releasePath = ""
local devPath = "https://raw.githubusercontent.com/AbdullahRasheed/cc-phone/refs/heads/main/delivery/"
local includePath = "https://raw.githubusercontent.com/AbdullahRasheed/cc-phone/refs/heads/main/delivery/include"
local args = {...}
...
for _, fileName in ipairs(includes) do
    downloadFile(devPath .. fileName, fs.combine("delivery", fileName), fileName, 0, currentFile + 1, #includes)
